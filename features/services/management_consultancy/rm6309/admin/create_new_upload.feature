Feature: Management Consultancy - Admin - Create new upload
  ...
  Scenario: I can upload successfully
    And I select the file 'data/management_consultancy/rm6309/Supplier details.xlsx' to upload for 'Supplier details'
    And I select the file 'data/management_consultancy/rm6309/Supplier rate cards.xlsx' to upload for 'Supplier rate cards'
    And I select the file 'data/management_consultancy/rm6309/Supplier service offerings.xlsx' to upload for 'Supplier service offerings'
