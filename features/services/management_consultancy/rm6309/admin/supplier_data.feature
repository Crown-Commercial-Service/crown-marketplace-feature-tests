Feature: Management Consultancy - Admin - Supplier data pages
  ...
  Scenario Outline: Supplier details page
    ...
    Examples:
      ...
      | ALTENWERTH INC | 672374543   | Yes | The Hon. Keesha Koch | altenwerth_inc@mosciski.biz       | (472) 754-2454      | http://flatley.co/arnulfo_weimann          | 64664 Dexter Ridge, Bobbieside, MD 42616-2987              |
      | CASSIN-HAAG    | 516829142   | No  | Lane Lynch           | haag_cassin@strosin-schmeler.name | (670) 255-8099 x141 | http://kessler-durgan.org/fernanda_goyette | Suite 410 94809 Halvorson Lakes, Hamillview, MO 25741-4808 |
      | THIEL-KUNDE    | 670639490   | No  | Ebony Crooks         | thiel.kunde@tillman-abshire.info  | 445-025-4485 x985   | http://boyle-wiza.org/laurence_veum        | Apt. 891 1631 Moses Overpass, North Fermina, GA 35083-4430 |

  Scenario: Lot status
    And I click on 'View lot data' for 'DURGAN AND SONS'
    Then I am on the 'Supplier lot data' page
    And the caption is 'DURGAN AND SONS'
