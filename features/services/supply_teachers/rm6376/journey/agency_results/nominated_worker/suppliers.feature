Feature: Supply Teachers - Agency results - Nominated worker - Agencies
  ...
  Scenario: The agency details shown are correct
    ...
    And the listed agencies with rates and distances are:
      | ROHAN LLC                  | London     | £32.70 | 0.0 |
      | GLOVER-ONDRICKA            | London     | £35.40 | 0.0 |
      | ROOB, CORWIN AND DICKI     | London     | £41.70 | 5.2 |
      | DANIEL AND SONS            | Twickenham | £52.70 | 9.1 |
      | TREMBLAY-WEST              | London     | £54.20 | 5.2 |
      | ROSENBAUM-HINTZ            | London     | £54.90 | 6.0 |
      | HEANEY GROUP               | London     | £58.30 | 5.2 |
      | DARE-ROHAN                 | Twickenham | £60.20 | 9.1 |
      | FRITSCH-HAHN               | London     | £70.70 | 6.0 |
      | TILLMAN-EMMERICH           | London     | £71.10 | 6.0 |
      | GRADY AND SONS             | London     | £71.60 | 0.0 |
      | SWANIAWSKI, CORWIN AND KUB | Twickenham | £72.90 | 9.1 |
  ...
  Scenario: Back buttons work
    ...
    And the listed agencies for agency results are:
      | ROHAN LLC                  | London     | £32.67 | 0.0 |
      | GLOVER-ONDRICKA            | London     | £35.41 | 0.0 |
      | ROOB, CORWIN AND DICKI     | London     | £41.74 | 5.2 |
      | DANIEL AND SONS            | Twickenham | £52.71 | 9.1 |
      | TREMBLAY-WEST              | London     | £54.20 | 5.2 |
      | ROSENBAUM-HINTZ            | London     | £54.86 | 6.0 |
      | HEANEY GROUP               | London     | £58.31 | 5.2 |
      | DARE-ROHAN                 | Twickenham | £60.19 | 9.1 |
      | FRITSCH-HAHN               | London     | £70.67 | 6.0 |
      | TILLMAN-EMMERICH           | London     | £71.10 | 6.0 |
      | GRADY AND SONS             | London     | £71.59 | 0.0 |
      | SWANIAWSKI, CORWIN AND KUB | Twickenham | £72.94 | 9.1 |
    Then I click on 'Back'
