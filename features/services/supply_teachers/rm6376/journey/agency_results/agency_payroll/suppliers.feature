Feature: Supply Teachers - Agency results - Agency payroll - Agencies
  ...
  Scenario: The agency details shown are correct
    ...
    And the listed agencies with rates and distances are:
      | ROHAN LLC                  | Liverpool | £37.34 | 7.6  |
      | GLOVER-ONDRICKA            | Liverpool | £40.47 | 7.6  |
      | SATTERFIELD AND SONS       | Liverpool | £52.28 | 0.0  |
      | NADER, CONN AND REINGER    | Liverpool | £52.62 | 0.0  |
      | GULGOWSKI-HUDSON           | Liverpool | £54.45 | 0.0  |
      | DANIEL AND SONS            | Liverpool | £60.24 | 2.0  |
      | ROSENBAUM-HINTZ            | Southport | £62.70 | 16.4 |
      | DARE-ROHAN                 | Liverpool | £68.79 | 2.0  |
      | FRITSCH-HAHN               | Southport | £80.77 | 16.4 |
      | TILLMAN-EMMERICH           | Southport | £81.26 | 16.4 |
      | GRADY AND SONS             | Liverpool | £81.81 | 7.6  |
      | SWANIAWSKI, CORWIN AND KUB | Liverpool | £83.36 | 2.0  |
