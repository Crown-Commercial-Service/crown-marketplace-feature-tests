...
Then('there are suppliers who can offer legal panel for government specialisms and I count them') do
  expect(legal_panel_for_government_page.number_of_suppliers.text.match(/\d+/).to_s.to_i).to be_positive
  @number_of_suppliers = legal_panel_for_government_page.number_of_suppliers.text
end
